...
public:
	...
	FT_VECTOR3D LeftHandPoint(UINT skeletonId) { return(m_LeftHandPoint[skeletonId]);};
    FT_VECTOR3D RightHandPoint(UINT skeletonId) { return(m_RightHandPoint[skeletonId]);};

private:
    IFTImage*   m_VideoBuffer;
    IFTImage*   m_DepthBuffer;
	FT_VECTOR3D m_LeftHandPoint[NUI_SKELETON_COUNT];
	FT_VECTOR3D m_RightHandPoint[NUI_SKELETON_COUNT];
