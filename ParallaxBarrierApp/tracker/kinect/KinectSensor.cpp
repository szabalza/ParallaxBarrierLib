...
void KinectSensor::GotSkeletonAlert()
{
    ...
    for( int i = 0 ; i < NUI_SKELETON_COUNT ; i++ )
    {
            ...
            NUI_SKELETON_POSITION_TRACKED == SkeletonFrame.SkeletonData[i].eSkeletonPositionTrackingState[NUI_SKELETON_POSITION_SHOULDER_CENTER])
        {
			...
			m_LeftHandPoint[i].x = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_LEFT].x;
            m_LeftHandPoint[i].y = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_LEFT].y;
            m_LeftHandPoint[i].z = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_LEFT].z;
			m_RightHandPoint[i].x = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_RIGHT].x;
            m_RightHandPoint[i].y = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_RIGHT].y;
            m_RightHandPoint[i].z = SkeletonFrame.SkeletonData[i].SkeletonPositions[NUI_SKELETON_POSITION_HAND_RIGHT].z;
        }
        else
        {
            m_HeadPoint[i] = m_NeckPoint[i] = FT_VECTOR3D(0, 0, 0);
...
HRESULT KinectSensor::GetClosestHint(FT_VECTOR3D* pHint3D)
{
	...
	pHint3D[2] = m_LeftHandPoint[selectedSkeleton];
    pHint3D[3] = m_RightHandPoint[selectedSkeleton];
